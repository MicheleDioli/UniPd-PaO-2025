...
compiler_moc_header_make_all: moc_Nuovo.cpp moc_ModificaArticolo.cpp moc_ModificaFilm.cpp moc_ModificaLibro.cpp moc_ModificaRivista.cpp moc_Cliccabile.cpp moc_FiltroLayout.cpp moc_ListaQT.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Nuovo.cpp moc_ModificaArticolo.cpp moc_ModificaFilm.cpp moc_ModificaLibro.cpp moc_ModificaRivista.cpp moc_Cliccabile.cpp moc_FiltroLayout.cpp moc_ListaQT.cpp
