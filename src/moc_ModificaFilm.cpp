...
#include "view/modifica/ModificaFilm.h"
...
template <> constexpr inline auto ModificaFilm::qt_create_metaobjectdata<qt_meta_tag_ZN12ModificaFilmE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ModificaFilm, qt_meta_tag_ZN12ModificaFilmE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject ModificaFilm::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ModificaFilmE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ModificaFilmE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12ModificaFilmE_t>.metaTypes,
    nullptr
} };
...
void *ModificaFilm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ModificaFilmE_t>.strings))
