...
struct qt_meta_stringdata_CLASSModificaRivistaENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSModificaRivistaENDCLASS = QtMocHelpers::stringData(
    "ModificaRivista"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSModificaRivistaENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ModificaRivista::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSModificaRivistaENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSModificaRivistaENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSModificaRivistaENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ModificaRivista::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSModificaRivistaENDCLASS.stringdata0))
