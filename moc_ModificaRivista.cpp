...
Q_CONSTINIT const QMetaObject ModificaRivista::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15ModificaRivistaE_t,
        ...
        QtPrivate::TypeAndForceComplete<Rivista *, std::false_type>,
...
void ModificaRivista::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->conferma((*reinterpret_cast< std::add_pointer_t<Rivista*>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ModificaRivista::*)(Rivista * );
            if (_q_method_type _q_method = &ModificaRivista::conferma; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ModificaRivista::conferma(Rivista * _t1)
{
